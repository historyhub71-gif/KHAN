...
const styles = StyleSheet.create({
  ...
  dateNavBtn: { paddingHorizontal: 12, paddingVertical: 14 },
  dateNavBtnDisabled: { opacity: 0.4 },
  dateDisplay: { flex: 1, alignItems: 'center', gap: 4 },
  dateText: { fontSize: 17, fontWeight: '600', textAlign: 'center' },
  todayBadge: { paddingHorizontal: 12, paddingVertical: 3, borderRadius: 10 },
  todayBadgeText: { fontSize: 11, fontWeight: '700' },
  summaryRow: { flexDirection: 'column', gap: 8, marginBottom: 16 },
  summaryCard: { flex: 1, borderRadius: 15, minWidth: '10%', padding: 12, alignItems: 'center', borderWidth: 1, },
  summaryCount: { fontSize: 22, fontWeight: '400', marginBottom: 2 },
  summaryLabel: { fontSize: 12, fontWeight: '400', textAlign: 'center' },
